const questions = [
    ...
    { question: "Which of the following declares a variable in JavaScript?", answer: "All of the above (let, var, const)" },
    ...
    { question: "What will typeof 'hello' return?", answer: "string" },
    { question: "Which method removes the last item from an array?", answer: "pop()" },
    ...
    { question: "Which loop type will always execute at least once?", answer: "do...while loop" },
    ...
    { question: "Which attribute improves accessibility for screen readers?", answer: "aria-label" },
    { question: "What is the role of state in React?", answer: "Stores component-specific data" },
    { question: "Which JavaScript event fires when a user clicks an element?", answer: "click" },
    { question: "Which tool helps debug JavaScript errors?", answer: "Console in DevTools" }
];
